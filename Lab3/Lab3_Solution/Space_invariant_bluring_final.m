...
%figure(1),subplot(1,2,2),imshow(img_zeropad),title('Zero padded Original Image');
...
figure(2),subplot(1,2,1),imshow(uint8(Blurred_img)),title('Zero padded Blurred Immage');
for  i=1:size(I,1)
    for j=1:size(I,1)
...
figure(2),subplot(1,2,2),imshow(uint8(I_blur)),title('Blurred Immage');
